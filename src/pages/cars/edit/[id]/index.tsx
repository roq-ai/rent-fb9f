      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="daily_rental_price" mb="4" isInvalid={!!formik.errors?.daily_rental_price}>
              <FormLabel>Daily Rental Price</FormLabel>
              <NumberInput
                name="daily_rental_price"
                value={formik.values?.daily_rental_price}
                onChange={(valueString, valueNumber) =>
                  formik.setFieldValue('daily_rental_price', Number.isNaN(valueNumber) ? 0 : valueNumber)
                }
              >
                <NumberInputField />
                <NumberInputStepper>
              ...
              {formik.errors.daily_rental_price && (
                <FormErrorMessage>{formik.errors?.daily_rental_price}</FormErrorMessage>
              )}
            </FormControl>
